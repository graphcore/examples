...
class TestTensorFlowGRUBenchmarks(SubProcessChecker):
    ...
    def test_inference_b256_s25_h1024(self):
        self.run_command("python3 gru.py --batch-size 256 --timesteps 25 --hidden-size 1024 --use-generated-data --popnn",
                         working_path,
                         [r"(\w+.\w+) items/sec"])
    ...
    def test_train_b64_s25_h512(self):
        self.run_command("python3 gru.py --batch-size 64 --timesteps 25 --hidden-size 512 --train --use-generated-data",
                         working_path,
                         [r"(\w+.\w+) items/sec"])
