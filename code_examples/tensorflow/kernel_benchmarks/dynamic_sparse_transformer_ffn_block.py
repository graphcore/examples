...
def get_ffn_flops(opts):
    ...
    work = forward_work + backward_work * int(opts.train)
...
if __name__ == '__main__':
    ...
    print(f" Dynamic Sparse Transformer Feed-forward Layer {'Train' if opts.train else 'Inference'} Synthetic benchmark.\n"
