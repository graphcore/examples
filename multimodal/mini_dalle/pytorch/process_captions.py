...
if __name__ == "__main__":
    ...
    parser.add_argument("--captions", type=str, default="./data/COCO/annotations/captions_train2017.json", help="captions annotation file")
    parser.add_argument("--out-dir", type=str, default="./data/COCO/train2017_captions", help="Directory storing processed caption files")
