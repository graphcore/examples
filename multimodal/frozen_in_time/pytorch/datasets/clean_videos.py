...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='Video Cleaner')
    parser.add_argument('--video_path', type=str, default='data/WebVid/videos/',
    ...
    parser.add_argument('--csv_path', type=str, default='data/WebVid/release/results_2M_train.csv',
                        help='Raw csv data path')
    parser.add_argument('--clean_csv_path', type=str, default='data/WebVid/metadata/results_2M_training.csv',
