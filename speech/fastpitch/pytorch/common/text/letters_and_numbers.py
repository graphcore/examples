...
_letters_and_numbers_re = re.compile(r"((?:[a-zA-Z]+[0-9]|[0-9]+[a-zA-Z])[a-zA-Z0-9']*)", re.IGNORECASE)

_hardware_re = re.compile("([0-9]+(?:[.,][0-9]+)?)(?:\s?)(tb|gb|mb|kb|ghz|mhz|khz|hz|mm)", re.IGNORECASE)
_hardware_key = {
    "tb": "terabyte",
    "gb": "gigabyte",
    "mb": "megabyte",
