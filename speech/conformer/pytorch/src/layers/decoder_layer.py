...
[
    https://github.com/espnet/espnet/blob/master/espnet/nets/pytorch_backend/transformer/decoder_layer.py
]
Main change:
...
from src.utils.remap_tensor import remap_tensor
...
class DecoderLayer(nn.Module):
    ...
    def forward(self, tgt, tgt_mask, memory, memory_mask, cache=None):
        ...
        if self.training:
            x = remap_tensor(x)  # fwd_grain_size=16, also can set to 8, 32
