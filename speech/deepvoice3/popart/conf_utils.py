...
def add_conf_args(run_mode):
    ...
    parser.add_argument('--global_batch_size', type=int, default=2,
                        help='Set global batch size for training.')
    parser.add_argument('--global_batch_size_for_inference', type=int, default=12,
                        help='Set global batch size for inference.')
    ...
    parser.add_argument('--device_iterations', type=int, default=50,
...
def get_conf(parser):
    ...
    conf.replica_batch_size_for_inference = int(conf.global_batch_size_for_inference / conf.replication_factor)
...
def set_model_conf(conf, print_model_conf=True):
    ...
    if conf.dataset == 'VCTK':
        ...
        raise Exception("Not supported dataset. Only VCTK dataset supported.")
