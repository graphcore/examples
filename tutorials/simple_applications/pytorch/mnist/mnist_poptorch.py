...
To learn more about PopTorch, see our [PyTorch for the IPU: User Guide](https://docs.graphcore.ai/projects/poptorch-user-guide/en/3.2.0/index.html).
"""
"""
...
PopTorch](https://docs.graphcore.ai/projects/poptorch-user-guide/en/3.2.0/pytorch_to_poptorch.html#preparing-your-data).
...
[deviceIterations](https://docs.graphcore.ai/projects/poptorch-user-guide/en/3.2.0/batching.html?highlight=deviceiteration#poptorch-options-deviceiterations)
to 50.
...
"""
Now let's set the [`OutputMode`](https://docs.graphcore.ai/projects/poptorch-user-guide/en/3.2.0/reference.html#poptorch.OutputMode)
...
of the PyTorch model. To train the model, we will use [SGD](https://docs.graphcore.ai/projects/poptorch-user-guide/en/3.2.0/reference.html#poptorch.optim.SGD),
