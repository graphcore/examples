...
if __name__ == "__main__":
    ...
    parser.add_argument("--alpha", help="sets the lrelu alpha attribute", type=float, default=0.02)
    parser.add_argument("--ipu", help="run on available IPU hardware device", action="store_true")
    parser.add_argument("input_data", metavar="X", type=float, nargs="+", help="input tensor data")
