...
def test_notebook():
    notebook_filename = TUTORIAL_ROOT_DIR / "4_small_graph_batching_with_packing.ipynb"
...
def test_python_file_code_only():
    python_filename = TUTORIAL_ROOT_DIR / "4_small_graph_batching_with_packing_code_only.py"
