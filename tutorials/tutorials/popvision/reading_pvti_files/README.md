...
Number of threads on process  74037 :  65
Number of events on thread  140157928945472 :  22
Event ' poplar::core::IPUDevice::attach ' lasted  126299  microseconds
...
```output
The longest epoch 'Epoch:5' lasted 3008878 microseconds.
The shortest epoch 'Epoch:8' lasted 2838683 microseconds.
Epochs took 2930475 microseconds on average, out of 10 epochs in total.
```
