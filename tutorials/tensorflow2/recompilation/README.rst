...
See `Caching of compiled executables
<https://docs.graphcore.ai/projects/tensorflow-user-guide/page/device_selection.html#caching-of-compiled-executables>`_
...
<https://docs.graphcore.ai/projects/tensorflow1-user-guide/en/latest/api.html#tensorflow.python.ipu.ipu_compiler.compile>`_
method as described in the
`model training documentation.
<https://docs.graphcore.ai/projects/tensorflow-user-guide/en/latest/perf_training.html#training-loops-data-sets-and-feed-queues>`_
Alternatively, higher level APIs can be used such as
`estimators
<https://docs.graphcore.ai/projects/tensorflow-user-guide/en/latest/api.html#module-tensorflow.python.ipu.ipu_estimator>`_
or, in TensorFlow 2, the combination of ``tf.function`` and the
`IPUStrategy
<https://docs.graphcore.ai/projects/tensorflow-user-guide/en/latest/api.html#tensorflow.python.ipu.ipu_strategy.IPUStrategy>`_.

For further details on how to wrap computational graphs, see the
`Graphcore TensorFlow documentation. <https://docs.graphcore.ai/projects/tensorflow-user-guide/en/latest/index.html>`_
...
`"xla_dump"
<https://github.com/tensorflow/tensorflow/blob/master/tensorflow/compiler/xla/debug_options_flags.cc#L444>`_
...
The first example is written for TensorFlow 2 as well as TensorFlow 1.

:download:`Download source <recompilation.py>`

.. literalinclude:: recompilation.py
    :linenos:
    :start-after: Copyright

The second example is specifically tailored to the new TensorFlow 2 API
...
:download:`Download source <TF2_recompilation.py>`

.. literalinclude:: TF2_recompilation.py
    :linenos:
    :start-after: Copyright
