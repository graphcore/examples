...
AVAILABLE_MODELS = {'resnet50': ResNet50,
                    ...
                    'toy_model': lambda weights, input_shape, classes, input_tensor: ToyModel(input_shape=input_shape, classes=classes, input_tensor=input_tensor),
                    'toy_model_bn': lambda weights, input_shape, classes, input_tensor: ToyModelBn(input_shape=input_shape, classes=classes, input_tensor=input_tensor)}
