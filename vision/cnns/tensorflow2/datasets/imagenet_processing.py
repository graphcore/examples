...
def _normalise_image(image):
    ...
    means = tf.broadcast_to(means, image_shape)
    std_dev = tf.broadcast_to(std_dev, image_shape)
...
def preprocess_image(image_buffer,
    ...
    if on_host_preprocess_fn is not None:
        image = on_host_preprocess_fn(image)
