...
class InferenceEmbeddedTest(SubProcessChecker):
    ...
    def test_embedded_inference_functionality(self):
        ...
        self._run_test_inference_embedded("python3 inference_embedded.py --model resnet --config resnet8_test --generated-data --iterations 10 --device-iterations 10 --micro-batch-size 1 --eight-bit-io --force-recompile")
