...
def add_args(parser):
    ...
    parser.set_defaults(device_iterations=1000, steps=5, convolution_options=None)
    return parser


def iteration_report(opts, time):
    return "{:5f} images/sec.".format(opts.batch_size * opts.replicas * opts.device_iterations / time)
