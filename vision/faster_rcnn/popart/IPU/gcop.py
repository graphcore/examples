...
import warnings
from basic_func import (safe_mode_on, safe_mode_off, set_memory_proportion,
                        set_options, set_builder, load_model, set_seed,
                        set_weight_fp16, set_load_strict, load_strict)
from initializers import (zeros_initializer, ones_initializer, constant_initializer,
