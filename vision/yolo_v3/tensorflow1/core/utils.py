...
def resize_image(image, target_size, gt_boxes=None):
    ...
    Args:
        image: input image
        target_size: a tuple or list of (h,w)
        gt_boxes: gt_boxes will be change the same way as image
    """
...
def postprocess_boxes(pred_bbox, org_img_shape, input_size, score_threshold):
    ...
    Args:
        ...
        score_threshold: box score threshold, boxes below this threshold will be discarded
    """
