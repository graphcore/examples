...
def parse_params():
    ...
    training_group.add_argument(
        "--train",
        action="store_true",
        help="Enable IPU training")
    training_group.add_argument(
        "--optimizer",
        choices=["sgd", "adam"],
        default="sgd",
        help="Choose optimizer used in training")
    training_group.add_argument(
        "--eval",
        action="store_true",
        help="Enable IPU validation")
    training_group.add_argument(
        "--infer",
        action="store_true",
        help="Enable IPU inference")
    training_group.add_argument(
        "--drop-rate",
        type=float,
        default=0.5,
    ...
    training_group.add_argument(
        ...
        type=int,
        default=240,
        help="The number of micro batches processed per execution")
    training_group.add_argument(
        "--micro-batch-size",
        type=int,
        default=1,
    ...
    training_group.add_argument(
        ...
        type=int,
        default=1,
        help="Set seed for random functions.")
    training_group.add_argument(
        "--num-epochs",
        type=int,
        default=2140,
    ...
    training_group.add_argument(
        ...
        type=float,
        default=0.9,
        help="Decay rate of learning rate schedue.")
    training_group.add_argument(
        "--momentum",
        type=float,
        default=0.99,
    ...
    training_group.add_argument(
        ...
        type=int,
        default=4,
        help="The number of executions per validation.")
    training_group.add_argument(
        "--kfold",
        type=int,
        default=1,
    ...
    training_group.add_argument(
        ...
        type=str,
        default="results",
        help="Directory to place checkpoints and predictions.")
    ...
    ipu_group.add_argument(
        ...
        type=int,
        default=1,
        help="The number of times to replicate the graph")
    ...
    data_group.add_argument(
        ...
        default='float16',
        type=str,
        help="Data type, default float16, else float32")
    data_group.add_argument(
        "--partials-type",
        default='half',
        choices=['half', 'float'],
    ...
    data_group.add_argument(
        "--host-generated-data",
        action='store_true',
        help="Use randomly generated data on host")
    data_group.add_argument(
        "--nb-classes",
        type=int,
        default=2,
    ...
    data_group.add_argument(
        "--use-prefetch",
        action="store_true",
        help="Use dataset prefetch.")
    data_group.add_argument(
        "--data-dir",
        type=str,
        default="data",
        help="Directory containing TIF image data")
