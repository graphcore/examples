...
class MPNN_TEST(SubProcessChecker):
    ...
    def test_graph_isomorphism_network(self):
        cmd = (
            "python3 run_training.py --model=graph_isomorphism --epochs=5 --replicas=1 "
    ...
    def test_graph_isomorphism_network_multi_replica(self):
        cmd = (
            "python3 run_training.py --model=graph_isomorphism --epochs=5 --replicas=2 "
    ...
    def test_interaction_network(self):
        cmd = (
            "python3 run_training.py --model=interaction_network --epochs=10 --replicas=1 "
    ...
    def test_graph_network(self):
        cmd = (
            "python3 run_training.py --model=graph_network --epochs=10 --replicas=1 --micro_batch_size=32 "
    ...
    def loss_seems_reasonable(self, losses, output, cmd):
        ...
        if not min_expected_loss < losses[-1] < max_expected_loss:
            self.fail(
                f"The loss is not converging to the desired value of ln(2).\n"
