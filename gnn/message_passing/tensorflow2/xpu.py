...
flags.DEFINE_enum("optimization_target", "cycles", ("balanced", "cycles", "memory"),
                  help="optimization target for the planner")
flags.DEFINE_enum("scheduling_algorithm", "CHOOSE_BEST", ("CHOOSE_BEST", "SHORTEST_PATH", "CLUSTERING"),
