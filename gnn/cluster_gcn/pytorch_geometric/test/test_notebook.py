...
def test_notebook():
    notebook_filename = EXAMPLE_ROOT_DIR / "node_classification_with_cluster_gcn.ipynb"
...
def test_python_file_code_only():
    python_filename = EXAMPLE_ROOT_DIR / "node_classification_with_cluster_gcn_code_only.py"
