...
from modelling.feed_forward import GPTFeedForwardTP, GPTFeedForwardTP2D
...
def test_feedforward_TP2D_cmp_TP(test_config: GPTConfig):
    np.random.seed(42)
    ...
    def TP(x_np, dy_np):
        ...
        with ir.main_graph:
            ...
            facts, graph = GPTFeedForwardTP(test_config).create_graph(x)
        ...
        weights = GPTFeedForwardTP.hf_mapping(test_config, vars, hf_model)
    ...
    def TP2D(x_np, dy_np):
        ...
        with ir.main_graph:
            ...
            facts, graph = GPTFeedForwardTP2D(test_config).create_graph(x)
        ...
        weights = GPTFeedForwardTP2D.hf_mapping(test_config, vars, hf_model)
