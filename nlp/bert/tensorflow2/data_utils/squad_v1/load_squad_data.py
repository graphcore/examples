...
def get_encodings_and_start_end_positions_from_example(example, tokenizer, max_seq_length, return_offsets_mapping=False):
...
def convert_train_example_to_tf_features(example, tokenizer, max_seq_length):
    encodings, start_positions, end_positions = get_encodings_and_start_end_positions_from_example(example, tokenizer, max_seq_length)
