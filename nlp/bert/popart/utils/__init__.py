...
def parse_bert_args(args_string=None):
    ...
    group.add_argument("--no-drop-remainder", type=str_to_bool, nargs="?", const=True, default=False,
                       help="Adjust the device_iterations to perfectly divide the dataset so no data is missed. Only available for SQuAD.")
    ...
    group.add_argument("--device-iterations", type=int, default=250,
