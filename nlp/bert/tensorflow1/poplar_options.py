...
def set_poplar_engine_options(
    ...
    memory_profile,
    profile_dir,
    sync_replicas_independently,
    synthetic_data,
    tensorflow_progress_bar,
    ipu_replica_identical_seed,
):
    ...
    if ipu_replica_identical_seed:
        replica_identical_seed_dict = {"target.deterministicWorkers": "true"}
        replica_identical_seed_dict.update(poplar_engine_options)
        poplar_engine_options = replica_identical_seed_dict

    if sync_replicas_independently:
        independent_sync_dict = {"target.syncReplicasIndependently": "true"}
