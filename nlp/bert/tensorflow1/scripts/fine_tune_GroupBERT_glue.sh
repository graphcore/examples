...
./run_classifier.py --config "${CONFIG_PATH}" --do-training --do-evaluation --do-predict --data-dir glue_data/"${DATA_NAME}"/ --task-name $2 --output-dir tmp/groupbert/$2/  --wandb --wandb-name "${WANDB_NAME}" --init-checkpoint "${PHASE2_CKPT_FILE}"
