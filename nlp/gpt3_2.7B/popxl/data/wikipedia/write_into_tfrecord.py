...
try:
    ...
    raise ImportError(
        "TensorFlow is required to generate data for this application. "
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input-file-path", default="./wikicorpus_en_one_article_per_line.pkl", required=False, type=str
    )
    parser.add_argument("--output-file-path", default="./tfrecords_50264_128/", required=False, type=str)
    parser.add_argument("--seq-length", default=129, type=int, required=False, help="sequence length of dataset")
    parser.add_argument("--stride", default=129, type=int, required=False, help="stride window size to sample dataset")
    parser.add_argument("--num-output", type=int, default=4, help="number of output files")
    args = parser.parse_args()
    write_instance_to_example_files(
        train_path=args.input_file_path,
