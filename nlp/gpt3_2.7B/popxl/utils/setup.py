...
def gpt_config_setup(
    ...
    config, args = parse_args_with_presets(GPTConfig, config_file, presets_key,
                                           default, argparse_args, CLI_args)
...
def xl_hf_config_check(config: GPTConfig, hf_config: HFConfig):
    ...
    params = [
        ...
        ('max_positional_length', config.model.embedding.max_positional_length,
...
def wandb_init(config: GPTConfig,
