...
def test_lm_TP_cmp_huggingface(test_config: GPTConfig):
    ...
    with main:
        ...
        pos_grad_d2h = addons.host_store(tensor_to_grad_tensor[graph.args.transformer.embeddings.positional.weight])
    ...
    grad_data_pos_full = np.concatenate(grad_data_pos, axis=0)[: test_config.model.embedding.max_positional_length, :]
