...
python3 run_pretraining.py --config configs/pretrain_large_384_POD128 \
                           --checkpoint-output-dir checkpoints/pretrain_large_384 \
                           --pretrained-checkpoint checkpoints/pretrain_large_128/step_N/