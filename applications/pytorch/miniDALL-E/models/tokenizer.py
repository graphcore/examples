...
@lru_cache()
def get_bpe(bpe_type = 0):
    if bpe_type == 0:
        return os.path.join(os.path.dirname(os.path.abspath(__file__)), "bpe/bpe_simple_vocab_16e6.txt")
    else:
        return os.path.join(os.path.dirname(os.path.abspath(__file__)), "bpe/bpe_yttm_vocab.txt")
...
class SimpleTokenizer(object):
    def __init__(self, bpe_path = get_bpe()):
...
class YttmTokenizer:
    def __init__(self, bpe_path = get_bpe(1)):
