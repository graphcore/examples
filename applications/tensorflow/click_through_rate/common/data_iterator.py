...
# It has been modified to support a different directory structure.
# The logic in the DataIterator has been changed.
...
class DataIterator:
    ...
    def __init__(self, source,
        ...
        f_meta = open("common/item-info", "r")
        meta_map = {}
        for line in f_meta:
        ...
        f_review = open("common/reviews-info", "r")
