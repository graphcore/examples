...
from .run_train import run_fine_tune_squad
...
def get_configs():
    ...
    filenames = [f for f in filenames if "squad_tiny" in f]
    return filenames
...
class TestBuild(object):
    ...
    def test_build(self, config):
        ...
        out = run_fine_tune_squad(**{'--config': config,
                                     '--num-train-steps': 10,
                                     '--generated-data': '',
                                     '--do-training': '',
