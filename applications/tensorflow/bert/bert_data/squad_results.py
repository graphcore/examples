...
def write_predictions(all_examples, all_features, all_results, n_best_size,
                      ...
                      is_version_2_with_negative, null_score_diff_threshold,
                      do_verbose_logging):
    ...
    for (example_index, example) in enumerate(all_examples):
        ...
        for (feature_index, feature) in enumerate(features):
            if feature.unique_id not in unique_id_to_result.keys():
                print(f"Can't find feature {feature.unique_id}")
                continue
        ...
        for pred in prelim_predictions:
            ...
            if pred.start_index > 0:  # this is a non-null prediction
                ...
                final_text = get_final_text(tok_text, orig_text, do_lower_case, do_verbose_logging)
