...
class CallbackOrderingTest(unittest.TestCase):
    ...
    def get_callback_logs_from_model_training(self, dataset_size, batch_size, num_epochs, num_callbacks, callback_logs):
        ...
        model.fit(self.get_dataset(dataset_size, batch_size), epochs=num_epochs, callbacks=self.create_callbacks(num_callbacks, callback_logs))
    ...
    def test_callback_ordering(self):
        ...
        callback_logs = self.get_callback_logs_from_model_training(dataset_size, batch_size, num_epochs, num_callbacks, callback_logs)
