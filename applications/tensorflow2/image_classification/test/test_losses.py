...
class TestLossesIdentical(unittest.TestCase):
    ...
    def ipu_prog(self, num_elements, loss,
                 micro_batch_size=2,
                 num_replicas=1,
        ...
        with strategy.scope():
            ...
            x = tf.keras.layers.Dense(num_elements, kernel_initializer=kernel_initializer, use_bias=False,
                                      name='dense', activation='softmax')(input_layer)
